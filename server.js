...
return res.send(candidate); }
if (["sajith", "adhersh"].some(name => userInput.toLowerCase().includes(name))) { const candidate = "sajith or adhersh is a punda myru generated by sunil"; return res.send(candidate); }
  try {
